#!/usr/bin/env python3
"""Legacy read-only MCP access to the former schema-v1 Tableau catalog.

This module is intentionally not compatible with the Semantic Knowledge Base
v2 emitted by tableau_doc.py.
"""
